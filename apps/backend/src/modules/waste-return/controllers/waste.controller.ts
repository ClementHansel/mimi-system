...
import { ApproveWasteDto, CreateWasteDto, ListWasteQueryDto, RejectWasteDto } from '../dto/waste.dto';
...
export class WasteController {
  ...
  approve(@Req() req: RequestWithDbContext, @Param('batchId') batchId: string, @Body() dto: ApproveWasteDto) {
  ...
  @RequirePermission('waste.approve')
  @Audited({ entityType: 'waste_record', action: 'waste.approve' })
  reject(@Req() req: RequestWithDbContext, @Param('batchId') batchId: string, @Body() dto: RejectWasteDto) {
