...
export const id = {
  ...
  status: {
    ...
    payment: { pending: 'Belum Terverifikasi', verified: 'Terverifikasi', paid: 'Dibayar' },
  ...
  driver: {
    ...
    coldChain: {
      breach: 'Suhu di luar batas aman rantai dingin (-25° s/d -15°C) — tetap dicatat sebagai bukti',
      stage: {
        load: 'Muat',
        depart: 'Berangkat',
        arrive: 'Tiba',
