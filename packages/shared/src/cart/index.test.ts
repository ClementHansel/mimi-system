...
describe('calculateLineTotal', () => {
  it('multiplies qty by unit price and subtracts the line discount', () => {
    expect(calculateLineTotal({ productId: 'p1', unitPrice: '45000.00', qty: '3.000', discount: '0.00' })).toBe('135000.00');
    expect(calculateLineTotal({ productId: 'p1', unitPrice: '45000.00', qty: '3.000', discount: '10000.00' })).toBe('125000.00');
  });

  it('floors at zero when the discount exceeds the line value', () => {
    expect(calculateLineTotal({ productId: 'p1', unitPrice: '10000.00', qty: '1.000', discount: '50000.00' })).toBe('0.00');
  });
});
...
describe('calculateCartSummary', () => {
  ...
  it('never produces a negative total', () => {
    const summary = calculateCartSummary([{ productId: 'p1', unitPrice: '1000.00', qty: '1.000', discount: '0.00' }], '999999.00');
...
describe('GoFood/ShopeeFood net-received math (FR-POS-05/07)', () => {
  const amounts = { grossAmount: '100000.00', discountAmount: '5000.00', platformFee: '15000.00', otherFee: '0.00' };
