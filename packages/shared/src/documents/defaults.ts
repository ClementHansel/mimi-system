...
const INVOICE_ELEMENTS: DocElement[] = [
  ...
  field('company_address', 'company_address', [M, 140, 340, 34], {
    fontSize: 10,
    color: 'brand.muted',
    wrap: true,
  }),
  field('company_phone', 'company_phone', [M, 176, 340, 16], {
    fontSize: 10,
    color: 'brand.muted',
  }),
  field('company_npwp', 'company_npwp', [M, 194, 340, 16], { fontSize: 10, color: 'brand.muted' }),

  field('document_title', 'document_title', [446, 40, 300, 40], {
    fontSize: 30,
    bold: true,
    align: 'right',
    color: 'brand.primary',
  }),
  field('invoice_number', 'invoice_number', [446, 84, 300, 20], {
    fontSize: 13,
    bold: true,
    align: 'right',
  }),
  field('invoice_date', 'invoice_date', [446, 106, 300, 16], {
    fontSize: 10,
    align: 'right',
    color: 'brand.muted',
  }),
  field('due_date', 'due_date', [446, 124, 300, 16], {
    fontSize: 10,
    align: 'right',
    color: 'brand.muted',
  }),
  field('source_label', 'source_label', [446, 142, 300, 16], {
    fontSize: 10,
    align: 'right',
    color: 'brand.accent',
  }),
  ...
  field('party_address', 'party_address', [M, 284, 340, 34], {
    fontSize: 10,
    color: 'brand.muted',
    wrap: true,
  }),
  field('party_phone', 'party_phone', [M, 318, 340, 16], { fontSize: 10, color: 'brand.muted' }),
  field('location_name', 'location_name', [446, 260, 300, 18], {
    fontSize: 10,
    align: 'right',
    color: 'brand.muted',
  }),
  field('issued_by', 'issued_by', [446, 278, 300, 18], {
    fontSize: 10,
    align: 'right',
    color: 'brand.muted',
  }),
  ...
  el('totals', 'totals', [446, 896, 300, 120], {
    fontSize: 12,
    color: 'brand.ink',
    align: 'right',
  }),
  field('payment_method', 'payment_method', [M, 896, 340, 16], {
    fontSize: 10,
    color: 'brand.muted',
  }),
  field('payment_status', 'payment_status', [M, 914, 340, 16], {
    fontSize: 10,
    color: 'brand.muted',
  }),
  field('notes', 'notes', [M, 940, 340, 44], { fontSize: 10, color: 'brand.muted', wrap: true }),
  field('terms', 'terms', [M, 1030, A4_CONTENT, 40], {
    fontSize: 9,
    color: 'brand.muted',
    wrap: true,
  }),
...
const RECEIPT_ELEMENTS: DocElement[] = [
  ...
  field('outlet_name', 'outlet_name', [T80_M, 52, T80_CONTENT, 20], {
    fontSize: 14,
    bold: true,
    align: 'center',
  }),
  field('outlet_address', 'outlet_address', [T80_M, 72, T80_CONTENT, 24], {
    fontSize: 9,
    align: 'center',
    color: 'brand.muted',
    wrap: true,
  }),
  field('outlet_phone', 'outlet_phone', [T80_M, 96, T80_CONTENT, 12], {
    fontSize: 9,
    align: 'center',
    color: 'brand.muted',
  }),
  ...
  field('receipt_number', 'receipt_number', [T80_M, 120, T80_CONTENT, 14], {
    fontSize: 10,
    bold: true,
  }),
  ...
  el('totals', 'totals', [T80_M, 524, T80_CONTENT, 90], {
    fontSize: 11,
    color: 'brand.ink',
    align: 'right',
  }),
  field('payment_method', 'payment_method', [T80_M, 618, T80_CONTENT, 14], {
    fontSize: 9,
    align: 'center',
    color: 'brand.muted',
  }),
  field('notes', 'notes', [T80_M, 634, T80_CONTENT, 38], {
    fontSize: 9,
    align: 'center',
    color: 'brand.muted',
    wrap: true,
...
const VOUCHER_ELEMENTS: DocElement[] = [
  ...
  field('company_name', 'company_name', [120, 20, 188, 18], {
    fontSize: 11,
    bold: true,
    align: 'right',
    color: 'brand.muted',
  ...
  field('voucher_name', 'voucher_name', [28, 58, 280, 22], {
    fontSize: 15,
    bold: true,
    color: 'brand.primary',
  }),
  field('voucher_value', 'voucher_value', [28, 80, 280, 32], {
    fontSize: 24,
    bold: true,
    color: 'brand.accent',
  }),

  el('qr', 'code', [228, 100, 80, 80], {
    codeType: 'qr',
    codeSource: 'voucher_code',
    align: 'center',
  }),
...
const SJ_ELEMENTS: DocElement[] = [
  ...
  field('company_address', 'company_address', [M, 122, 360, 30], {
    fontSize: 10,
    color: 'brand.muted',
    wrap: true,
  }),

  field('document_title', 'document_title', [446, 40, 300, 34], {
    fontSize: 24,
    bold: true,
    align: 'right',
    color: 'brand.primary',
  ...
  field('sj_date', 'sj_date', [446, 100, 300, 16], {
    fontSize: 10,
    align: 'right',
    color: 'brand.muted',
  }),
  field('copy_holder_label', 'copy_holder_label', [446, 118, 300, 18], {
    fontSize: 11,
    bold: true,
    align: 'right',
    color: 'brand.accent',
  ...
  field('destination_address', 'destination_address', [M, 216, 330, 30], {
    fontSize: 10,
    color: 'brand.muted',
    wrap: true,
  }),
  ...
  field('shipment_type_label', 'shipment_type_label', [416, 210, 330, 18], {
    fontSize: 10,
    align: 'right',
  }),
  field('drop_label', 'drop_label', [416, 228, 330, 18], {
    fontSize: 10,
    align: 'right',
    bold: true,
  }),
  field('seal_number', 'seal_number', [M, 250, 330, 16], { fontSize: 10, color: 'brand.muted' }),
  field('temp_c', 'temp_c', [416, 250, 330, 16], {
    fontSize: 10,
    align: 'right',
    color: 'brand.muted',
  }),
  ...
  field('notes', 'notes', [M, 866, A4_CONTENT, 40], {
    fontSize: 10,
    wrap: true,
    color: 'brand.muted',
  }),

  el('sig_sender', 'signature', [M, 930, 210, 110], {
    signatureRole: 'sender',
    fontSize: 10,
    color: 'brand.ink',
  }),
  el('sig_driver', 'signature', [292, 930, 210, 110], {
    signatureRole: 'driver',
    fontSize: 10,
    color: 'brand.ink',
  }),
  el('sig_receiver', 'signature', [536, 930, 210, 110], {
    signatureRole: 'receiver',
    fontSize: 10,
    color: 'brand.ink',
  }),

  field('page_label', 'page_label', [M, 1070, A4_CONTENT, 16], {
    fontSize: 9,
    align: 'center',
    color: 'brand.muted',
  }),
