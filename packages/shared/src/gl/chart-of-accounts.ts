...
export const CHART_OF_ACCOUNTS_SEED: readonly ChartOfAccountsSeed[] = [
  ...
  {
    code: '5090',
    name: 'Penyesuaian Nilai Persediaan',
    type: AccountType.EXPENSE,
    normalBalance: NormalBalance.DEBIT,
  },
  {
    code: '5100',
    name: 'Beban Waste/Rusak/Expired',
    type: AccountType.EXPENSE,
    normalBalance: NormalBalance.DEBIT,
  },
  {
  ...
  {
    code: '6010',
    name: 'Beban BPJS (Perusahaan)',
    type: AccountType.EXPENSE,
    normalBalance: NormalBalance.DEBIT,
  },
  {
    code: '6100',
    name: 'Beban Operasional Outlet',
    type: AccountType.EXPENSE,
    normalBalance: NormalBalance.DEBIT,
  },
  {
    code: '6200',
    name: 'Beban Maintenance',
    type: AccountType.EXPENSE,
    normalBalance: NormalBalance.DEBIT,
  },
  {
    code: '6300',
    name: 'Beban Komisi Platform',
    type: AccountType.EXPENSE,
    normalBalance: NormalBalance.DEBIT,
  },
  {
    code: '6400',
    name: 'Beban Selisih Stok',
    type: AccountType.EXPENSE,
    normalBalance: NormalBalance.DEBIT,
  },
];
